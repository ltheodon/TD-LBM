...
k      = 3; % to fill in;                                              % The constant k is defined by k^(1/2) = c_s_a = c_s_d/c_r_d     with c_s_d = sqrt(tilde(R).T)    and   c_r_d = Deltax_d /Deltat_d   
...
k_t    = 3;                                            % The constant k is defined by k^(1/2) = c_s_a = c_s_d/c_r_d     with c_s_d = sqrt(tilde(R).T)    and   c_r_d = Deltax_d /Deltat_d   
